						...
						<!-- logo -->
						 <div class="search-form me-auto ms-xxl-5 ps-lg-5 d-none d-xl-block">
							<form action="#" class="position-relative">
								<button><img src="{{ URL::asset('assets/images/icon/icon_38.svg') }}" alt=""></button>
						...
						<div class="right-widget ms-lg-5 ps-xxl-5 me-3 me-lg-0 order-lg-3">
							<ul class="d-flex align-items-center style-none">
								...
								<li class="d-none d-md-inline-block ms-4">
                                    <a href="signup" class="btn-five tran3s">Sign Up</a>
                                </li>
							</ul>
						</div>
				...
				<div class="row">
					<div class="col-xl-6 col-lg-7">
						<div class="pe-xxl-5">
							...
							<a href="#" class="btn-five color-two tran3s">Try It Now</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-9 m-auto text-center">
						...
						<a href="contact-v2" class="btn-five color-two tran3s">Let’s Get Started</a>
					</div>
				</div>
			</div>
		</div>
