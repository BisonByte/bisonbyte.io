				...
				<div class="row">
					<div class="col-xxl-7 col-lg-6 order-lg-last">
						<div class="ps-lg-5 ms-xxl-4 md-mb-60">
							...
							<a href="#" class="btn-two xl">Order Your Card Now!</a>
						</div>
					</div>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6 wow fadeInLeft">
						<div class="title-one mb-30 mt-50">
							<h2>Globally  Send Money <span class="d-inline-block position-relative">with <img src="{{ URL::asset('assets/images/shape/shape_03.svg') }}" alt="" class="d-inline-block"></span> <br> Low Fees</h2>
						</div>
				...
				<div class="row align-items-center mt-100 md-mt-30">
					<div class="col-lg-6 wow fadeInRight order-lg-last">
						<div class="ps-xl-5">
							<div class="title-one mb-30 mt-50">
								<h2>Withdraw money from <span class="d-inline-block position-relative">an ATM <img src="{{ URL::asset('assets/images/shape/shape_03.svg') }}" alt="" class="d-inline-block"></span></h2>
							</div>
		...
		<div class="faq-section-one bg-four position-relative z-1 pt-150 lg-pt-80 pb-120 lg-pb-80 border-30 mb-30 lg-mb-20">
			<div class="container">
				...
				<div class="text-center mt-60 lg-mt-40">
					...
					<a href="contact-v1" class="btn-two xl">Contact us</a>
				</div>
			</div>
