    ...
    <div class="main-page-wrapper bg-five">
        ...
        <div id="preloader">
            <div id="ctn-preloader" class="ctn-preloader">
                <div class="icon"><img src="{{ URL::asset('assets/images/loader.svg') }}" alt="" class="m-auto d-block"> <span></span>
                </div>
        ...
        <!--
              ...
              ==============================================
              -->
        <div class="offcanvas offcanvas-end sidebar-nav" tabindex="-1" id="sideNav"
            ...
            <div class="wrapper mt-10 h-100">
                <div class="d-flex flex-column h-100">
                        ...
                        <ul class="style-none">
                            <li class="nav-item">
                                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false" data-bs-auto-close="outside">Home</a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false" data-bs-auto-close="outside">Portfolio</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="project-details" class="dropdown-item"><span>Project Details</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                    ...
                    <ul
                        class="style-none d-flex flex-wrap w-100 justify-content-between align-items-center social-icon pt-25 mt-auto">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="right-widget ms-auto ms-lg-0 order-lg-3">
                            <ul class="d-flex align-items-center style-none">
                                ...
                                <li class="ms-4"><button class="sidenavbtn rounded-circle tran3s" type="button"
                                        data-bs-toggle="offcanvas" data-bs-target="#sideNav" aria-controls="sideNav"><i
                                            class="fa-sharp fa-light fa-bars-filter"></i></button></li>
                            </ul>
                        </div>
                    </div>
                </div> <!--/.top-header-->
        ...
        <div class="blog-section-one mt-200 xl-mt-150 mb-120 lg-mb-80">
            <div class="container">
                    ...
                    <div class="isotop-item application life">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            ...
                            <div class="post-meta position-relative z-1">
                                ...
                                <a href="blog-details" class="blog-title d-block">
                                    <h4>How to become a web designer in 2021</h4>
                                </a>
                                <div class="d-lg-flex justify-content-between align-items-center">
                                    ...
                                    <a href="blog-details" class="read-more rounded-circle tran3s md-mt-20"><i
                    ...
                    <div class="isotop-item application dev other">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            ...
                            <div class="post-meta position-relative z-1">
                                ...
                                <a href="blog-details" class="blog-title d-block">
                                    <h4>Make Productive Day with AI app</h4>
                                </a>
                                <div class="d-lg-flex justify-content-between align-items-center">
                                    <ul class="style-none tags d-flex flex-wrap">
                                        <li><a href="#">AI</a></li>
                    ...
                    <div class="isotop-item market design dev other">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            ...
                            <div class="post-meta position-relative z-1">
                                ...
                                <a href="blog-details" class="blog-title d-block">
                                    <h4>Speaking remotely at WordCamp US</h4>
                                </a>
                                <div class="d-lg-flex justify-content-between align-items-center">
                                    <ul class="style-none tags d-flex flex-wrap">
                    ...
                    <div class="isotop-item application">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            ...
                            <div class="post-meta position-relative z-1">
                                <div class="date">09 mar, 2024</div>
                                <a href="blog-details" class="blog-title d-block">
                                    <h4>Designer’s Checklist for Every UX Project</h4>
                                </a>
                                <div class="d-lg-flex justify-content-between align-items-center">
                                    <ul class="style-none tags d-flex flex-wrap">
                    ...
                    <div class="isotop-item market design dev">
                        <article class="blog-meta-one style-two mb-70 lg-mb-40">
                            ...
                            <div class="post-meta position-relative z-1">
                                <div class="date">13 apr, 2024</div>
                                <a href="blog-details" class="blog-title d-block">
                                    <h4>Spending Habits, 13 Tips for Success.</h4>
                                </a>
                                <div class="d-lg-flex justify-content-between align-items-center">
                                    <ul class="style-none tags d-flex flex-wrap">
                                        <li><a href="#">Tips</a></li>
                ...
                <ul class="pagination-one d-flex justify-content-center align-items-center style-none pt-40">
                    ...
                    <li><a href="#">2</a></li>
                    <li><a href="#">3</a></li>
                    <li class="ms-2"><a href="#" class="d-flex align-items-center">Next <img
                                src="{{ URL::asset('assets/images/icon/icon_15.svg') }}" alt="" class="ms-2"></a></li>
                </ul>
            </div>
        </div>
        <!-- /.blog-section-one -->
                            ...
                            <div class="col-lg-5 me-auto">
                                <div class="footer-intro mb-30 me-xxl-5 pe-xxl-4">
                                    ...
                                    <form action="#" class="position-relative">
                                        ...
                                        <button class="tran3s"><img src="{{ URL::asset('assets/images/icon/icon_05.svg') }}" alt=""
                                                class="m-auto"></button>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="bottom-footer">
                        <div class="d-md-flex align-items-center justify-content-between">
                            <div class="d-flex justify-content-center align-items-center sm-mb-20">
                                ...
                                <img src="{{ URL::asset('assets/images/shape/shape_19.svg') }}" alt=""
                                    class="ms-5 d-none d-md-block">
                            </div>
