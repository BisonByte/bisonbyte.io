                        ...
                        <div class="row gx-xxl-5">
                            <div class="col-lg-4">
                                <div class="card-style-fifteen text-center mt-25">
                                    <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="{{ URL::asset('assets/images/icon/icon_90.svg') }}" alt=""></div>
                                    <h6>Collect Doc</h6>
                            ...
                            <div class="col-lg-4">
                                <div class="card-style-fifteen text-center mt-25">
                                    <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="{{ URL::asset('assets/images/icon/icon_91.svg') }}" alt=""></div>
                            ...
                            <div class="col-lg-4">
                                <div class="card-style-fifteen text-center mt-25">
                                    <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="{{ URL::asset('assets/images/icon/icon_92.svg') }}" alt=""></div>
                                    <h6>Completedy</h6>
