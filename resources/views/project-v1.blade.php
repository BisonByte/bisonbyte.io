			...
			<div id="isotop-gallery-wrapper" class="grid-2column">
                ...
                <div class="isotop-item application brand mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_38.jpg') }}" alt="" class="w-100 media-img tran3s">
                ...
                <div class="isotop-item design mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_39.jpg') }}" alt="" class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
                ...
                <div class="isotop-item market dev mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_40.jpg') }}" alt="" class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
                ...
                <div class="isotop-item market brand mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_41.jpg') }}" alt="" class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
                ...
                <div class="isotop-item application dev mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_42.jpg') }}" alt="" class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
                ...
                <div class="isotop-item design mb-30">
                    <div class="project-block-two position-relative z-1">
                        <img src="{{ URL::asset('assets/images/media/img_43.jpg') }}" alt="" class="w-100 media-img tran3s">
                        <a href="project-details" class="btn-one rounded-circle"><i class="bi bi-arrow-up-right"></i></a>
                    </div>
                    <!-- /.project-block-two -->
                </div>
