						...
						<div class="right-widget order-lg-3 ms-auto me-3 me-lg-0">
							<ul class="d-flex align-items-center style-none">
								...
								<li class="d-none d-sm-inline-block">
									<a href="#" class="login-btn-one fw-500 d-flex align-items-center tran3s"><img src="{{ URL::asset('assets/images/icon/icon_18.svg') }}" alt="" class="me-2"> <span>My Account</span></a>
                                </li>
							</ul>
						</div>
							...
							<div class="collapse navbar-collapse" id="navbarNav">
								<ul class="navbar-nav align-items-lg-center">
									...
									<li class="d-md-none ps-3 pe-3 mt-20">
										<a href="#" class="login-btn-one fw-500 d-flex justify-content-center align-items-center tran3s"><img src="{{ URL::asset('assets/images/icon/icon_18.svg') }}" alt="" class="me-2"> <span>My Account</span></a>
									</li>
									<li class="d-md-none ps-3 pe-3 mt-20">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-xxl-3 col-lg-4 col-md-6">
                            <div class="card-style-thirteen d-flex w-100 mt-35">
                                <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="{{ URL::asset('assets/images/icon/icon_64.svg') }}" alt=""></div>
                                <div class="text">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-style-thirteen d-flex w-100 mt-35">
                                <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="{{ URL::asset('assets/images/icon/icon_65.svg') }}" alt=""></div>
                                <div class="text">
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-6">
                            <div class="card-style-thirteen d-flex w-100 mt-35">
                                <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="{{ URL::asset('assets/images/icon/icon_66.svg') }}" alt=""></div>
                                <div class="text">
                ...
                <div class="row gx-xxl-5 mt-30 lg-mt-10">
                    <div class="col-lg-4">
                        <div class="card-style-fourteen mt-35">
                            ...
                            <a href="service-details" class="cta-btn border-2 border-top border-start border-dark tran3s d-flex align-items-center justify-content-center"><img src="{{ URL::asset('assets/images/icon/icon_70.svg') }}" alt=""></a>
                        </div>
                        <!-- /.card-style-fourteen -->
                    </div>
                    <div class="col-lg-4">
                ...
                <div class="row gx-xxl-5">
                    <div class="col-lg-4">
                        <div class="card-style-fifteen text-center mt-25">
                            <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="{{ URL::asset('assets/images/icon/icon_74.svg') }}" alt=""></div>
                    ...
                    <div class="col-lg-4">
                        <div class="card-style-fifteen text-center mt-25">
                            <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="{{ URL::asset('assets/images/icon/icon_75.svg') }}" alt=""></div>
                    ...
                    <div class="col-lg-4">
                        <div class="card-style-fifteen text-center mt-25">
                            <div class="icon d-flex align-items-center justify-content-center border border-2 border-dark rounded-circle"><img src="{{ URL::asset('assets/images/icon/icon_76.svg') }}" alt=""></div>
