						...
						<div class="right-widget ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
							<ul class="d-flex align-items-center style-none">
								...
								<li class="d-none d-md-inline-block ms-3">
                                    <a href="signup" class="btn-seven">Try it Now</a>
                                </li>
							</ul>
						</div>
							...
							<div class="collapse navbar-collapse" id="navbarNav">
								<ul class="navbar-nav align-items-lg-center">
									...
									<li class="d-md-none ps-3 pe-3 mt-20">
										<a href="signup" class="btn-seven w-100">Try it Now</a>
									</li>
								</ul>
							</div>
						</nav>
					...
					<div class="client-logo-wrapper mt-100 lg-mt-50">
						<div class="container">
							...
							<div class="partner-logo-one">
								<div class="item"><img src="{{ URL::asset('assets/images/logo/p_logo_01.png') }}" alt=""></div>
								<div class="item"><img src="{{ URL::asset('assets/images/logo/p_logo_02.png') }}" alt=""></div>
								<div class="item"><img src="{{ URL::asset('assets/images/logo/p_logo_03.png') }}" alt=""></div>
								<div class="item"><img src="{{ URL::asset('assets/images/logo/p_logo_04.png') }}" alt=""></div>
								<div class="item"><img src="{{ URL::asset('assets/images/logo/p_logo_05.png') }}" alt=""></div>
								<div class="item"><img src="{{ URL::asset('assets/images/logo/p_logo_06.png') }}" alt=""></div>
								<div class="item"><img src="{{ URL::asset('assets/images/logo/p_logo_03.png') }}" alt=""></div>
								<div class="item"><img src="{{ URL::asset('assets/images/logo/p_logo_04.png') }}" alt=""></div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-6 order-lg-last">
							<div class="ms-lg-5 ps-xxl-3">
								...
								<a href="faq-v1" class="btn-seven">Explore More <i class="fa-sharp fa-regular fa-arrow-right-long"></i></a>
							</div>
						</div>
                    ...
                    <nav class="filter-nav">
                        <div class="nav nav-tabs align-items-center justify-content-center justify-content-xl-between border-0" role="tablist">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#finance" type="button" role="tab" aria-controls="finance" aria-selected="true">
                                <img src="{{ URL::asset('assets/images/icon/icon_23.svg') }}" alt="" class="shapes icon">
                                <img src="{{ URL::asset('assets/images/icon/icon_23_w.svg') }}" alt="" class="shapes icon icon_w">
                                Finance & Payment
                            </button>
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#task" type="button" role="tab" aria-controls="task" aria-selected="false">
                                <img src="{{ URL::asset('assets/images/icon/icon_24.svg') }}" alt="" class="shapes icon">
                                <img src="{{ URL::asset('assets/images/icon/icon_24_w.svg') }}" alt="" class="shapes icon icon_w">
                                Collaboration & Task
                            </button>
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#market" type="button" role="tab" aria-controls="market" aria-selected="false">
                                <img src="{{ URL::asset('assets/images/icon/icon_25.svg') }}" alt="" class="shapes icon">
                                <img src="{{ URL::asset('assets/images/icon/icon_25_w.svg') }}" alt="" class="shapes icon icon_w">
						...
						<div class="row gx-xxl-5">
							<div class="col-lg-4">
								<div class="pr-column">
									...
									<a href="#" class="btn-eleven mt-50 mb-50">Get Started</a>
					...
					<div class="row align-items-center">
						<div class="col-lg-6 order-lg-last">
							<div class="ms-lg-5">
								...
								<a href="#" class="btn-seven">See all Apps</a>
							</div>
						</div>
						<div class="col-lg-6 order-lg-first">
							<div class="media position-relative md-mt-40">
					...
					<div class="position-relative z-1">
						<div class="row">
							<div class="col-xl-9 col-lg-8 m-auto">
								...
								<a href="#" class="btn-eleven">Get Started</a>
							</div>
						</div>
