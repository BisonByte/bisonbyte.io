				...
				<div class="row">
                    <div class="col-lg-7 order-lg-last">
                        <div class="ps-xl-5 ms-xxl-5">
                            <p class="fs-22 fw-500 text-dark mb-65 md-mb-40">Piku offers virtual debit cards, FDIC-insured USD accounts through City Savings.</p>
                            <p class="fs-22 fw-500 text-dark">Online shopping or holiday expenses, auto-converts currencies at the lowest fees, ensuring hassle-free transactions globally.</p>
			...
			<div class="row gx-xl-4">
				<div class="col-lg-4 d-flex wow fadeInUp mt-30 lg-mt-20">
					<div class="card-style-one text-center border-30 bg-four w-100">
						<div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="{{ URL::asset('assets/images/icon/icon_80.svg') }}" alt=""></div>
				...
				<div class="col-lg-4 d-flex wow fadeInUp mt-30 lg-mt-20" data-wow-delay="0.1s">
					<div class="card-style-one text-center border-30 bg-four w-100">
						<div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="{{ URL::asset('assets/images/icon/icon_81.svg') }}" alt=""></div>
				...
				<div class="col-lg-4 d-flex wow fadeInUp mt-30 lg-mt-20" data-wow-delay="0.2s">
					<div class="card-style-one text-center border-30 bg-four w-100">
						<div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="{{ URL::asset('assets/images/icon/icon_82.svg') }}" alt=""></div>
						<h3>Transfer Home</h3>
                ...
                <div class="col-lg-4 d-flex wow fadeInUp mt-30 lg-mt-20">
					<div class="card-style-one text-center border-30 bg-four w-100">
						<div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="{{ URL::asset('assets/images/icon/icon_83.svg') }}" alt=""></div>
				...
				<div class="col-lg-4 d-flex wow fadeInUp mt-30 lg-mt-20" data-wow-delay="0.1s">
					<div class="card-style-one text-center border-30 bg-four w-100">
						<div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="{{ URL::asset('assets/images/icon/icon_84.svg') }}" alt=""></div>
						<h3>Multi-Currency <br>Card</h3>
						<p class="fs-24 fw-500 text-dark">No monthly charges for holding your money in the account indefinitely.</p>
					</div>
					<!-- /.card-style-one -->
				</div>
				<div class="col-lg-4 d-flex wow fadeInUp mt-30 lg-mt-20" data-wow-delay="0.2s">
					<div class="card-style-one text-center border-30 bg-four w-100">
						<div class="icon rounded-circle d-flex align-items-center justify-content-center m-auto"><img src="{{ URL::asset('assets/images/icon/icon_85.svg') }}" alt=""></div>
						<h3>E-Wallet Facility</h3>
						<p class="fs-24 fw-500 text-dark">Return money to your local bank with the best available market rates.</p>
					</div>
					<!-- /.card-style-one -->
				</div>
